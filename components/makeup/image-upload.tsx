        ...
        try {
          ...
          if (landmarks) {
            ...
            toast({
              title: "Face detected! ✨",
              description:
                "Ready to apply makeup. Choose a category to get started.",
            });
          } else {
            ...
            toast({
              ...
              description:
                "Please upload an image with a clear, front-facing face.",
              variant: "destructive",
            });
          }
        } catch (error) {
        ...
        >
          ...
          <div className="flex flex-col items-center space-y-4">
            ...
            {uploadStatus === "idle" && (
              <Button
                variant="outline"
                className="mt-4 border-rose-200 text-signature hover:text-signature bg-transparent"
              >
                Choose File
              </Button>
            )}
