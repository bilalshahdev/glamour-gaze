...
export function AppliedMakeupList() {
  ...
  const appliedItems = Object.entries(makeupConfig).filter(([_, config]) => config !== null)
      ...
      <CardHeader className="pb-3">
        <div className="flex items-center justify-between">
          ...
          <Button
            ...
            className="h-6 text-xs px-2 bg-fuchsia-gradient hover:opacity-90 text-white"
          >
            ...
            >
              <div className="flex items-center gap-2 flex-1">
                ...
                <div className="flex-1">
                  ...
                  <p className="text-xs text-muted-foreground">{Math.round(config.opacity * 100)}% opacity</p>
                </div>
              </div>
