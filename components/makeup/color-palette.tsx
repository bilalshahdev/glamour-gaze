...
export function ColorPalette() {
  const { selectedCategory, updateMakeupConfig, makeupConfig } =
    useMakeupStore();
  const [customOpacity, setCustomOpacity] = useState<number>(0.7);

  const filteredPresets =
    colorPalettes[selectedCategory as keyof typeof colorPalettes] || [];
  ...
  const currentMakeup =
    makeupConfig[selectedCategory as keyof typeof makeupConfig];
  ...
  return (
    <Card className="glass border-fuchsia-200/20 dark:border-fuchsia-800/20 animate-slideInRight">
      ...
      <CardContent className="space-y-4">
        ...
        <div className="space-y-2 border rounded-lg shadow p-2">
          ...
          <Slider
            ...
            onValueChange={(value) => {
              ...
              if (currentMakeup) {
                updateMakeupConfig(
                  selectedCategory as keyof typeof makeupConfig,
                  {
                    ...currentMakeup,
                    opacity: value[0],
                  }
        ...
        <div className="grid grid-cols-3 sm:grid-cols-4 md:grid-cols-2 gap-3 max-h-96 overflow-y-auto">
          {filteredPresets.map((preset: MakeupPreset, index: number) => {
            ...
            return (
              <Button
                ...
                className={`
                  ...
                  ${
                    isActive
                      ? "ring-2 ring-fuchsia-500 bg-fuchsia-50 dark:bg-fuchsia-950/20 border-fuchsia-300"
                      : "hover:bg-fuchsia-50 dark:hover:bg-fuchsia-950/20 hover:border-fuchsia-300"
                  }
                `}
              ...
              >
                <div
                  className={`w-6 h-6 rounded-full border-2 border-gray-200 dark:border-gray-600 shadow-sm ${
                    preset?.shimmer ? "animate-pulse-slow" : ""
                  }`}
        ...
        <div className="pt-2 border-t border-fuchsia-200/20 dark:border-fuchsia-800/20">
          <p className="text-xs text-muted-foreground text-center">
            💄 Tap any color to try it instantly
          </p>
        </div>
      </CardContent>
    </Card>
